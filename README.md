...
- A web-based pharmacy portal for managing medicines, orders, and user accounts.  

### 🔹 [Ride Booking System](#)  
*Tech:* Java, MySQL  
- A desktop application inspired by **Uber/PickMe** with ride booking and driver allocation.  

### 🔹 [TK Fitness App](#)  
*Tech:* Android Studio (Kotlin + XML), Figma  
- Mobile fitness application prototype with workout tracking, gym booking, and video tutorials.  
...
⭐️ *“Code, Learn, and Keep Building!”* ⭐️
